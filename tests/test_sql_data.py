...
DB_SERVER = "localhost"  # Change if needed
...
def db_connection():
    ...
    conn = pymssql.connect(server=DB_SERVER, port="1433", user=DB_USER, password=DB_PASSWORD, database=DB_DATABASE,  tds_version='7.3')
    yield conn
    conn.close()
